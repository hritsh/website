...
#exp_item(
  ...
  [Achieved >90% sepsis prediction accuracy by deploying PyTorch models trained on ICU data of 200,000+ patients.],
  ...
  [Collaborating with Medical Experts & Regulatory teams to ensure compliance with FDA & CE standards.],
)
